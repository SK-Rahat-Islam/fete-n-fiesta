...
<section class="birthday" id="birthday">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3 class="title">Organization 1</h3>
            <h3 class="amount">9000 ৳ </h3>
            <ul>
                <li> <i class="fas fa-check"></i> Snacks </li>
                <li> <i class="fas fa-check"></i> Ballons </li>
                <li><i class="fas fa-check"></i>Birthday cake</li>
                <li> <i class="fas fa-check"></i> Invitation card </li>
                <li> <i class="fas fa-check"></i>Candles and Napkins </li>
        ...
        <div class="box">
            <h3 class="title">Organization 2</h3>
            <h3 class="amount">11500 ৳ </h3>
            <ul>
                <li> <i class="fas fa-check"></i> Music </li>
                <li> <i class="fas fa-check"></i> Decorations </li>
                <li><i class="fas fa-check"></i>Birthday cake</li>
                <li> <i class="fas fa-check"></i> Paper towels </li>
                <li> <i class="fas fa-check"></i> Food and beverage party supplies</li>
        ...
        <div class="box">
            <h3 class="title">Organization 3</h3>
            <h3 class="amount">15000 ৳</h3>
            <ul>
                <li> <i class="fas fa-check"></i> Music </li>
                <li> <i class="fas fa-check"></i> Decorations </li>
                <li><i class="fas fa-check"></i>Birthday cake</li>
        ...
        <div class="box">
            <h3 class="title">Organization 4</h3>
            <h3 class="amount">17300 ৳</h3>
            <ul>
                <li> <i class="fas fa-check"></i> Decorations </li>
                <li><i class="fas fa-check"></i>Birthday cake</li>
                <li> <i class="fas fa-check"></i> Paper towels </li>
                <li> <i class="fas fa-check"></i> Invitation card </li>
                <li> <i class="fas fa-check"></i> Tables and chairs </li>
                <li> <i class="fas fa-check"></i> Food and beverage party supplies</li>
        ...
        <div class="box">
            <h3 class="title">Organization 5</h3>
            <h3 class="amount">19900 ৳ </h3>
            <ul>
                <li> <i class="fas fa-check"></i> Decorations </li>
                <li><i class="fas fa-check"></i> Birthday cake</li>
                <li> <i class="fas fa-check"></i> Paper towels </li>
                <li> <i class="fas fa-check"></i> Invitation card </li>
                <li> <i class="fas fa-check"></i> Tables and chairs </li>
                <li> <i class="fas fa-check"></i> Entertainment rentals</li>
                <li> <i class="fas fa-check"></i> Food and beverage party supplies</li>
        ...
        <div class="box">
            <h3 class="title">Organization 6</h3>
            <h3 class="amount">20000 ৳ </h3>
            <ul>
                <li> <i class="fas fa-check"></i> Decorations </li>
                <li> <i class="fas fa-check"></i> Invitation card </li>
        ...
        <div class="box">
            <h3 class="title">Organization 7</h3>
            <h3 class="amount">29690 ৳</h3>
            <ul>
                <li> <i class="fas fa-check"></i> Photos </li>
                <li> <i class="fas fa-check"></i> Dj Party </li>
                <li> <i class="fas fa-check"></i> Decorations </li>
                <li> <i class="fas fa-check"></i> Invitation card </li>
                <li> <i class="fas fa-check"></i> Tables and chairs </li>
                <li> <i class="fas fa-check"></i> Entertainment rentals</li>
        ...
        <div class="box">
            <h3 class="title">Organization 8</h3>
            <h3 class="amount">32900 ৳</h3>
            <ul>
                ...
                <li> <i class="fas fa-check"></i> Tables and chairs </li>
                <li> <i class="fas fa-check"></i> Entertainment rentals</li>
                <li> <i class="fas fa-check"></i> Plates (appetizer,dinner, dessert)</li>
                <li> <i class="fas fa-check"></i> Food and beverage party supplies</li>
