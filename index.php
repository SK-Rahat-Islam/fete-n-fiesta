...
<body>
    ...
    <header class="header">
        ...
        <ul class="navbar-nav">
            <nav class="menu"><a href="index.php">Home</a>
                <nav class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">Services<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <a href="login.php">Weddings</a>
                        <a href="login.php">Transport</a>
                        <a href="login.php">Birthday</a>
                        <a href="login.php">Concerts</a>
                        <a href="login.php">Photos & videos</a>
                        <a href="login.php">Custom Food</a>
                    </ul>
                </nav>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <a href="login.php" class="btn"> <i class="fa-solid fa-phone"></i> Contact Now </a>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <p>We're optimistic for a future where people will be able to organize their events without being stressed. We see a world where technology enhances human potential, and takes us into a new era of intelligence and progress that everyone can benefit from.</p>
        ...
        <div class="review-slider swiper-container">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    ...
                    <p>Nice work 😍 All the best for the team.</p>
                </div>
