...
<section class="cfood" id="cfood">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <ul>
                <li> <i class="fas fa-check"></i> Tehari</li>
                <li> <i class="fas fa-check"></i> Snacks</li>
                <li> <i class="fas fa-check"></i> Chinese items </li>
                <li> <i class="fas fa-check"></i> Party Custom items</li>
                <li> <i class="fas fa-check"></i> Birthday Custom cake</li>
                <li> <i class="fas fa-check"></i> Wedding Custom items</li>
                <li> <i class="fas fa-check"></i> Biriyani (Beef, Mutton, Chicken)</li>
        ...
        <div class="box">
            ...
            <h3 class="amount">20200 ৳</h3>
            <ul>

                <li> <i class="fas fa-check"></i> Sushi</li>
                <li> <i class="fas fa-check"></i> Chinese items </li>
                <li> <i class="fas fa-check"></i> Party Custom items</li>
                <li> <i class="fas fa-check"></i> Birthday Custom cake</li>
                <li> <i class="fas fa-check"></i> Wedding Custom items</li>
