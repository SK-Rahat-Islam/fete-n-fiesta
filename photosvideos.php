...
<section class="pv" id="pv">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3 class="title">Photography Team 1</h3>
            <h3 class="amount">12000 ৳ </h3>
            <ul>

                <li> <i class="fas fa-check"></i> Lighting</li>
                <li> <i class="fas fa-check"></i> Set design</li>
        ...
        <div class="box">
            <h3 class="title">Photography Team 2</h3>
            <h3 class="amount">19500 ৳ </h3>
            <ul>
                <li> <i class="fas fa-check"></i> Food photography</li>
                <li> <i class="fas fa-check"></i> Product photography</li>
                <li> <i class="fas fa-check"></i> Portrait Photography</li>
        ...
        <div class="box">
            <h3 class="title">Photography Team 3</h3>
        ...
        <div class="box">
            <h3 class="title">Photography Team 4</h3>
        ...
        <div class="box">
            <h3 class="title">Photography Team 5</h3>
            <h3 class="amount">15500 ৳ </h3>
            <ul>
                <li> <i class="fas fa-check"></i> Lighting</li>
                <li> <i class="fas fa-check"></i> Set design</li>
                <li> <i class="fas fa-check"></i> Photo editing </li>
                <li> <i class="fas fa-check"></i> Food photography</li>
                <li> <i class="fas fa-check"></i> Documentary-style photography</li>

            </ul>
            <a href="contact.php" class="btn">Check Out</a>
        </div>
        <div class="box">
            <h3 class="title">Photography Team 6</h3>
            <h3 class="amount">20500 ৳ </h3>
            <ul>
        ...
        <div class="box">
            <h3 class="title">Photography Team 7</h3>
            <h3 class="amount">21200৳</h3>
            <ul>
        ...
        <div class="box">
            <h3 class="title">Photography Team 8</h3>
            <h3 class="amount">23400 ৳</h3>
            <ul>
