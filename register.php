...
if (isset($_POST['create'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($pass != $c_pass) {
            ...
            $insert = "INSERT INTO users (f_name, l_name, u_name, gender, d_birth, p_num, email, u_type, pass, c_pass, agree) VALUES ('$f_name','$l_name', '$u_name','$gender','$d_birth','$p_num','$email', '$u_type', '$pass','$c_pass','$agree')";
...
<body>
    ...
    <div class="form">
        ...
        <form method="POST">
            ...
            <input type="date" placeholder="BirthDay" name="d_birth" class="form-control" />
            <input type="tel" placeholder="Phone Number" name="p_num" class="form-control" />
            <input type="email" placeholder="Email" name="email" class="form-control" />
            <div class="nav">
                <li><label for="radioBox4">Admin</label>
                    <input id="radioBox4" type="radio" name="u_type" value="Admin">
                </li>
                <li><label for="radioBox5">User</label>
                    <input id="radioBox5" type="radio" name="u_type" value="User">
                </li>
            </div>

            <input type="password" placeholder="Password" name="pass" class="form-control" />
            <input type="password" placeholder="Confirm Password" name="c_pass" class="form-control" />
